...
public class QSample extends EntityPathBase<Sample> {
    ...
    private static final long serialVersionUID = 1858244149L;
    ...
    public final ListPath<SampleItem, QSampleItem> sampleItemList = this.<SampleItem, QSampleItem>createList("sampleItemList", SampleItem.class, QSampleItem.class, PathInits.DIRECT2);
